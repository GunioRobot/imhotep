...
def bind():
    ...
    _attrs_4326063632 = _loads('(dp1\n.')
    _lookup_attr = _loads('cchameleon.core.codegen\nlookup_attr\np1\n.')
    _attrs_4326063568 = _loads('(dp1\nVtype\np2\nVsubmit\np3\nsVid\np4\nVx\nsVvalue\np5\nVSearch\np6\ns.')
    _re_amp = _loads("cre\n_compile\np1\n(S'&(?!([A-Za-z]+|#[0-9]+);)'\np2\nI0\ntRp3\n.")
    _attrs_4326093328 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#change-history\np3\ns.')
    _attrs_4326062672 = _loads('(dp1\nVclass\np2\nVtop align-center\np3\ns.')
    _attrs_4326093712 = _loads('(dp1\nVhref\np2\nVirc://irc.freenode.net#pyramid\np3\ns.')
    _attrs_4326062032 = _loads('(dp1\nVmedia\np2\nVscreen\np3\nsVcharset\np4\nVutf-8\np5\nsVhref\np6\nV${request.application_url}/static/pylons.css\np7\nsVrel\np8\nVstylesheet\np9\nsVtype\np10\nVtext/css\np11\ns.')
    _attrs_4326064016 = _loads('(dp1\n.')
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _attrs_4326093072 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#api-documentation\np3\ns.')
    _attrs_4326093264 = _loads('(dp1\n.')
    _attrs_4326093584 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#support-and-development\np3\ns.')
    _attrs_4326063184 = _loads('(dp1\nVid\np2\nVleft\np3\nsVclass\np4\nValign-right\np5\ns.')
    _attrs_4326062544 = _loads('(dp1\nVclass\np2\nVheader\np3\ns.')
    _attrs_4326063504 = _loads('(dp1\nVname\np2\nVq\nsVvalue\np3\nV\nsVtype\np4\nVtext\np5\nsVid\np6\nVq\ns.')
    _attrs_4326093456 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#sample-applications\np3\ns.')
    _attrs_4326062864 = _loads('(dp1\nVclass\np2\nVapp-welcome\np3\ns.')
    _attrs_4326092944 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#narrative-documentation\np3\ns.')
    _attrs_4326063120 = _loads('(dp1\nVclass\np2\nVfooter\np3\ns.')
    _attrs_4326061648 = _loads('(dp1\n.')
    _attrs_4326061584 = _loads('(dp1\n.')
    _attrs_4326062096 = _loads('(dp1\nVmedia\np2\nVscreen\np3\nsVcharset\np4\nVutf-8\np5\nsVhref\np6\nVhttp://fonts.googleapis.com/css?family=Nobile:regular,italic,bold,bolditalic&subset=latin\np7\nsVrel\np8\nVstylesheet\np9\nsVtype\np10\nVtext/css\np11\ns.')
    _attrs_4326092880 = _loads('(dp1\n.')
    _attrs_4326061776 = _loads('(dp1\nVcontent\np2\nVtext/html;charset=UTF-8\np3\nsVhttp-equiv\np4\nVContent-Type\np5\ns.')
    _attrs_4326062352 = _loads('(dp1\nVid\np2\nVfooter\np3\ns.')
    _init_tal = _loads('cchameleon.core.generation\ninitialize_tal\np1\n.')
    _attrs_4326063248 = _loads('(dp1\nVid\np2\nVright\np3\nsVclass\np4\nValign-left\np5\ns.')
    _attrs_4326063312 = _loads('(dp1\n.')
    _init_default = _loads('cchameleon.core.generation\ninitialize_default\np1\n.')
    _attrs_4326063888 = _loads('(dp1\n.')
    _attrs_4326093008 = _loads('(dp1\n.')
    _attrs_4326062416 = _loads('(dp1\nVid\np2\nVheader\np3\ns.')
    _attrs_4326093136 = _loads('(dp1\n.')
    _attrs_4326063056 = _loads('(dp1\n.')
    _attrs_4326062800 = _loads('(dp1\nVsrc\np2\nV${request.application_url}/static/logo.png\np3\nsVwidth\np4\nV300\np5\nsVheight\np6\nV80\np7\ns.')
    _attrs_4326062608 = _loads('(dp1\nVid\np2\nVbottom\np3\ns.')
    _attrs_4326062992 = _loads('(dp1\nVclass\np2\nVapp-name\np3\ns.')
    _attrs_4326062288 = _loads('(dp1\nVid\np2\nVwrap\np3\ns.')
    _attrs_4326093520 = _loads('(dp1\n.')
    _attrs_4326063824 = _loads('(dp1\n.')
    _attrs_4326063376 = _loads('(dp1\nVaction\np2\nVhttp://docs.pylonshq.com/pyramid/dev/search.html\np3\nsVmethod\np4\nVget\np5\ns.')
    _attrs_4326093200 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/pyramid/dev/#tutorials\np3\ns.')
    _init_scope = _loads('cchameleon.core.utils\necontext\np1\n.')
    _attrs_4326063696 = _loads('(dp1\nVclass\np2\nVlinks\np3\ns.')
    _attrs_4326062480 = _loads('(dp1\nVid\np2\nVtop\np3\ns.')
    _attrs_4326063952 = _loads('(dp1\nVhref\np2\nVhttp://pylonshq.com\np3\ns.')
    _attrs_4326062928 = _loads('(dp1\nVclass\np2\nVbottom\np3\ns.')
    _attrs_4326093392 = _loads('(dp1\n.')
    _attrs_4326061904 = _loads('(dp1\nVcontent\np2\nVpyramid web application\np3\nsVname\np4\nVdescription\np5\ns.')
    _attrs_4326061712 = _loads('(dp1\n.')
    _attrs_4326061968 = _loads('(dp1\nVhref\np2\nV${request.application_url}/static/favicon.ico\np3\nsVrel\np4\nVshortcut icon\np5\ns.')
    _attrs_4326064080 = _loads('(dp1\nVhref\np2\nVhttp://docs.pylonshq.com/\np3\ns.')
    _attrs_4326061840 = _loads('(dp1\nVcontent\np2\nVpython web application\np3\nsVname\np4\nVkeywords\np5\ns.')
    _attrs_4326061456 = _loads('(dp1\nVxmlns\np2\nVhttp://www.w3.org/1999/xhtml\np3\nsVxml:lang\np4\nVen\np5\ns.')
    def render(econtext, rcontext=None):
        ...
        attrs = _attrs_4326061648
        _write(u'<body>\n\t')
        attrs = _attrs_4326062288
        _write(u'<div id="wrap">\n\t\t')
        attrs = _attrs_4326062416
        _write(u'<div id="header">\n\t\t\t')
        attrs = _attrs_4326062544
        _write(u'<div class="header">The Pyramid Web Application Development Framework</div>\n\t\t</div>\n\t\t')
        attrs = _attrs_4326062480
        _write(u'<div id="top">\n\t\t\t')
        attrs = _attrs_4326062672
        _write(u'<div class="top align-center">\n\t\t\t\t')
        attrs = _attrs_4326062800
        ...
        attrs = _attrs_4326062864
        _write(u'<p class="app-welcome">\n\t\t\t\t\tWelcome to ')
        attrs = _attrs_4326062992
        u'project'
